...
- Metadata Hash: 0aaa7c22

## Benchmark Results

| Benchmark | Time (ns) | CPU (ns) | Iterations | Repetitions | Threads | 
| --------- | --------- | -------- | ---------- | ----------- | ------- | 
| BM_FloatAddition | 2.09 | 2.09 | 292319514 | 1 | 1 | 
...
1000029d0:     	cbz	w0, 0x1000029e4 <BM_FloatAddition(benchmark::State&)+0x88>
1000029d4:     	b	0x1000029d8 <BM_FloatAddition(benchmark::State&)+0x7c>
1000029d8:     	mov	x8, #0
1000029dc:     	str	x8, [sp, #24]
;       : cached_(st->skipped() ? 0 : st->max_iterations), parent_(st) {}
1000029e0:     	b	0x1000029f4 <BM_FloatAddition(benchmark::State&)+0x98>
1000029e4:     	ldur	x8, [x29, #-56]
1000029e8:     	ldr	x8, [x8, #16]
1000029ec:     	str	x8, [sp, #24]
1000029f0:     	b	0x1000029f4 <BM_FloatAddition(benchmark::State&)+0x98>
...
;   StartKeepRunning();
100002a58:     	b	0x100002a5c <BM_FloatAddition(benchmark::State&)+0x100>
...
100002a78:     	ldr	x8, [x8]
100002a7c:     	cbz	x8, 0x100002a90 <BM_FloatAddition(benchmark::State&)+0x134>
100002a80:     	b	0x100002a84 <BM_FloatAddition(benchmark::State&)+0x128>
100002a84:     	mov	w8, #1
;     if (BENCHMARK_BUILTIN_EXPECT(cached_ != 0, true)) return true;
100002a88:     	sturb	w8, [x29, #-97]
100002a8c:     	b	0x100002aa8 <BM_FloatAddition(benchmark::State&)+0x14c>
100002a90:     	ldr	x8, [sp, #16]
;     parent_->FinishKeepRunning();
100002a94:     	ldr	x0, [x8, #8]
100002aa4:     	b	0x100002aa8 <BM_FloatAddition(benchmark::State&)+0x14c>
;   }
100002aa8:     	ldurb	w8, [x29, #-97]
;   for (auto _ : state) {
100002aac:     	subs	w8, w8, #1
100002ab0:     	b.ne	0x100002b38 <BM_FloatAddition(benchmark::State&)+0x1dc>
100002ab4:     	b	0x100002ab8 <BM_FloatAddition(benchmark::State&)+0x15c>
...
;   for (auto _ : state) {
100002adc:     	b	0x100002ae0 <BM_FloatAddition(benchmark::State&)+0x184>
...
100002afc:     	b.gt	0x100002b24 <BM_FloatAddition(benchmark::State&)+0x1c8>
100002b00:     	b	0x100002b04 <BM_FloatAddition(benchmark::State&)+0x1a8>
100002b34:     	b	0x100002a5c <BM_FloatAddition(benchmark::State&)+0x100>
; }
...
- [Raw Benchmark Results](/results/darwin-arm64-Apple-M3-Pro/clang-20.1.2/Debug_O0/0aaa7c22/float_addition)
