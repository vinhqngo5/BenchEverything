...
- Metadata Hash: 845f2637

## Benchmark Results

| Benchmark | Time (ns) | CPU (ns) | Iterations | Repetitions | Threads | 
| --------- | --------- | -------- | ---------- | ----------- | ------- | 
| BM_FloatAddition | 2.05 | 2.05 | 336031184 | 1 | 1 | 
...
1000029ec:     	cbz	w0, 0x100002a00 <BM_FloatAddition(benchmark::State&)+0x88>
1000029f0:     	b	0x1000029f4 <BM_FloatAddition(benchmark::State&)+0x7c>
1000029f4:     	mov	x8, #0
1000029f8:     	str	x8, [sp, #24]
;       : cached_(st->skipped() ? 0 : st->max_iterations), parent_(st) {}
1000029fc:     	b	0x100002a10 <BM_FloatAddition(benchmark::State&)+0x98>
100002a00:     	ldur	x8, [x29, #-56]
100002a04:     	ldr	x8, [x8, #16]
100002a08:     	str	x8, [sp, #24]
100002a0c:     	b	0x100002a10 <BM_FloatAddition(benchmark::State&)+0x98>
...
;   StartKeepRunning();
100002a74:     	b	0x100002a78 <BM_FloatAddition(benchmark::State&)+0x100>
...
100002a94:     	ldr	x8, [x8]
100002a98:     	cbz	x8, 0x100002aac <BM_FloatAddition(benchmark::State&)+0x134>
100002a9c:     	b	0x100002aa0 <BM_FloatAddition(benchmark::State&)+0x128>
100002aa0:     	mov	w8, #1
;     if (BENCHMARK_BUILTIN_EXPECT(cached_ != 0, true)) return true;
100002aa4:     	sturb	w8, [x29, #-97]
100002aa8:     	b	0x100002ac4 <BM_FloatAddition(benchmark::State&)+0x14c>
100002aac:     	ldr	x8, [sp, #16]
;     parent_->FinishKeepRunning();
100002ab0:     	ldr	x0, [x8, #8]
100002ac0:     	b	0x100002ac4 <BM_FloatAddition(benchmark::State&)+0x14c>
;   }
100002ac4:     	ldurb	w8, [x29, #-97]
;   for (auto _ : state) {
100002ac8:     	subs	w8, w8, #1
100002acc:     	b.ne	0x100002b54 <BM_FloatAddition(benchmark::State&)+0x1dc>
100002ad0:     	b	0x100002ad4 <BM_FloatAddition(benchmark::State&)+0x15c>
...
;   for (auto _ : state) {
100002af8:     	b	0x100002afc <BM_FloatAddition(benchmark::State&)+0x184>
...
100002b18:     	b.gt	0x100002b40 <BM_FloatAddition(benchmark::State&)+0x1c8>
100002b1c:     	b	0x100002b20 <BM_FloatAddition(benchmark::State&)+0x1a8>
100002b50:     	b	0x100002a78 <BM_FloatAddition(benchmark::State&)+0x100>
; }
...
- [Raw Benchmark Results](/results/darwin-arm64-Apple-M3-Pro/gcc-15.0.0/Debug_O0/845f2637/float_addition)
